...
function sendMOVEReminder() {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var subject = 'See you tomorrow — MOVE with Issa Rae + Spencer Paysinger';
    ...
    var html =
      ...
      '<p style="color:#444;font-size:15px;line-height:1.65;margin:0 0 28px;">Tomorrow is MOVE — and you are on the list.</p>' +
      ...
      // What it is / isn't
      '<p style="font-size:15px;font-weight:600;color:#111;margin:0 0 8px;">What MOVE is</p>' +
      '<p style="font-size:14px;color:#555;line-height:1.65;margin:0 0 20px;">A free community walk and run — your pace, your distance. Movement as part of mental wellness, not a performance.</p>' +

      '<p style="font-size:15px;font-weight:600;color:#111;margin:0 0 8px;">What MOVE is not</p>' +
      '<p style="font-size:14px;color:#555;line-height:1.65;margin:0 0 28px;">Not a race, not a health screening. No paperwork at the door. Just community, moving together.</p>' +
      ...
      '<p style="margin:4px 0;font-size:14px;color:#111;">MOVE &nbsp;&middot;&nbsp; May 9 &nbsp;<span style="color:#233dff;font-weight:600;">Tomorrow</span></p>' +
      ...
      // Schedule
      '<p style="font-size:15px;font-weight:600;color:#111;margin:0 0 10px;">Tomorrow\'s schedule</p>' +
      ...
      '<p style="font-size:14px;color:#555;line-height:1.65;margin:0 0 28px;">Curtis R. Tucker Wellness Center, Inglewood.<br>Top section of the parking lot, behind the buildings.</p>' +
      ...
      '<p style="margin:0 0 4px;font-size:12px;color:#999;font-weight:600;text-transform:uppercase;letter-spacing:.08em;">Opens at 7:15 AM on May 9</p>' +
      '<p style="margin:0 0 20px;font-size:14px;color:#555;line-height:1.55;">Your waiver and check-in are handled in one step from your phone on event day. Nothing to print.</p>' +
      '<a href="' + checkinUrl + '" style="display:inline-block;background:#233dff;color:#fff;padding:15px 48px;border-radius:30px;text-decoration:none;font-family:Arial,sans-serif;font-weight:700;font-size:15px;letter-spacing:.02em;">Check In on Event Day</a>' +
      '</div>' +

      '<p style="font-size:14px;color:#555;line-height:1.65;margin:0 0 6px;">See you in the morning.</p>' +
    ...
    var plain =
      'Hi ' + firstName + ',\n\n' +
      'Tomorrow is MOVE — and you are on the list.\n\n' +
      ...
      'WHERE TO GO\n' +
      'Curtis R. Tucker Wellness Center, Inglewood\n' +
      'Top section of the parking lot, behind the buildings.\n\n' +
      'WHAT TO WEAR\n' +
      'Comfortable shoes and layers — mornings can be cool.\n\n' +
      'CHECK IN ON EVENT DAY (opens 7:15 AM)\n' +
      checkinUrl + '\n\n' +
